...
Please note that this website is currently slightly out-dated with respect to the published book. I'm slowly working my way through the entire book to correct any inconsistencies. At the same time I'm updating terms (e.g., macOS instead of Mac OS X) and sections (e.g., [Installing the Docker image](#docker-image) instead of *Setting up the Data Science Toolbox*) where appropriate. ---Jeroen Janssens, January 20, 2018.
```
