...
You'll start with the following files:
...
I assume that the plain text contains data, but that it has no clear tabular structure (like CSV does) or nested structure (like JSON, XML, and HTML do).
