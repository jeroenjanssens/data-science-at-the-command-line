...
Imagine that you have obtained the first 100 items of a *fizzbuzz* sequence (cf. [Chapter 4](#chapter-4-creating-reusable-command-line-tools)) and that you'd like to visualize how often the words *fizz*, *buzz*, and *fizzbuzz* appear using a bar chart.
...
tee fb.seq | trim
```
<1> The custom tool `fizzbuzz.py` comes from [Chapter 4](#chapter-4-creating-reusable-command-line-tools).
