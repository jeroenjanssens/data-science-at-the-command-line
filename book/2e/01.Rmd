...
\@ref(fig:osemn) illustrates that doing data science is an iterative and non-linear process.
...
```{r osemn, echo=FALSE, fig.cap="Doing data science is an iterative and non-linear process", fig.align="center"}
