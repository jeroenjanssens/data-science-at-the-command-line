...
In this section I'm going to train a model that can classify wines as either red or wine.
While `vw` could be used for this, I'd like to demonstrate another tool: SciKit-Learn Laboratory (SKLL).
