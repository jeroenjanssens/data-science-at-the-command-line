...
<!-- TODO: CH: I'm assuming audience from context, but I think if supervised vs. unsupervised is explained (earlier in the  chapter), it might make sense to add a quick (even one sentence) explanation of training and test datasets. -->
