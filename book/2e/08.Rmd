...
\@ref(fig:processing) illustrates, on a conceptual level, the difference between serial processing, naive parallel processing, and parallel processing with GNU Parallel in terms of the number of concurrent processes and the total amount of time it takes to run everything. 

```{r processing, echo=FALSE, fig.cap="Serial processing, naive parallel processing, and parallel processing with GNU Parallel", fig.align="center"}
knitr::include_graphics("images/diagram_processing.png")
```
...
\@ref(fig:processing) illustrates this.
...
```{r parallel, echo=FALSE, fig.cap="Storing results in separate files (placeholder)", fig.align="center"}
knitr::include_graphics("images/diagram_parallel.png")
```
...
As a data scientist, you work with data--sometimes a lot of data.
