...
See \@ref(fig:diagram-parallel-results) for an illustration of how `parallel` concurrently distributes input among processes and collects their outputs.

```{r diagram-parallel-results, echo=FALSE, fig.cap="GNU Parallel concurrently distributes input among processes and collects their outputs", fig.align="center"}
