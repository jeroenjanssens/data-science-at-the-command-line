...
3. The *.SHELLFLAGS* line makes Bash more strict, which is considered a best practice.[^4] For example, because of this, the pipeline in the rule for target *top10* now stops as soon as there is an error.
...
[^4]: See http://redsymbol.net/articles/unofficial-bash-strict-mode/ for more information.
