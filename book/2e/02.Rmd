...
```{r diagram-essential-channels, echo=FALSE, fig.cap="Diagram", fig.align="center"}
knitr::include_graphics("images/diagram_essential_channels.png")
```

```{r diagram-essential-pipe-redirect, echo=FALSE, fig.cap="Diagram", fig.align="center"}
knitr::include_graphics("images/diagram_essential_pipe_redirect.png")
```

```{r diagram-essential-stdin-cat, echo=FALSE, fig.cap="Diagram", fig.align="center"}
knitr::include_graphics("images/diagram_essential_stdin_cat.png")
```

```{r diagram-essential-devnull, echo=FALSE, fig.cap="Diagram", fig.align="center"}
knitr::include_graphics("images/diagram_essential_devnull.png")
```

```{r diagram-essential-tee, echo=FALSE, fig.cap="Diagram", fig.align="center"}
knitr::include_graphics("images/diagram_essential_tee.png")
```

```{r diagram-essential-sponge, echo=FALSE, fig.cap="Diagram", fig.align="center"}
