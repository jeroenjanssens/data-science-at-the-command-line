...
The same result can be achieved with the following syntax:
...
For example, imagine you have a file *dates.txt* and you want to add line numbers using `nl`[@nl].
If you run the following, *dates.txt* will end up empty.
