...
An advantage of this option is that most image viewers automatically update the image when it has changed, which allows for quick iterations as you fine-tune your visualization.
...
The Docker container has a small tool called `servewd`[@servewd], which serves the current working directory using Python:
...
The default port is 8000, but you can easily change this:
