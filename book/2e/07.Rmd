...
Figure \@ref(fig:screenshot-display-ansi-and-inline) is awesome.

```{r screenshot-display-ansi-and-inline, echo=FALSE, fig.cap="Viewing an image in the terminal via ANSI (top) and via the iTerm2 inline images protocol (bottom)", fig.align="center"}
knitr::include_graphics("images/screenshot_display_ansi_and_inline.png")
```

Figure \@ref(fig:screenshot-display-preview-and-browser) is awesome too.

```{r screenshot-display-preview-and-browser, echo=FALSE, fig.cap="Viewing an image externally via an image viewer (left) and a browser (browser)", fig.align="center"}
