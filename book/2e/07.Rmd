...
```
```{r plot_bar_image, echo=FALSE, fig.cap="Bar chart", fig.align="center", out.width="90%"}
...
auto geom
<!-- plot uses heuristics to determine the appropriate geometry, but you can override this. -->

fill color

```{console plot_histogram_ansi, trailing_spaces=TRUE, remove=c(-2, -1)}
rush plot --x tip --fill sex tips.csv
```
...
doesn't look too good (not everything looks equally good).
textual output certainly has limitations. 
```{console plot_density_ansi, trailing_spaces=TRUE, remove=c(-2, -1)}
rush plot --x tip --fill sex --geom density tips.csv
```


```{console plot_density_png}
rush plot --x tip --fill sex --geom density tips.csv > plot-density.png
display plot-density.png
```
```{r plot_density_image, echo=FALSE, fig.cap="density", fig.align="center", out.width="90%"}
...
Which geometry types and aesthetics you can use depend on the columns you specify.
...
```
```{r plot_accident_image, echo=FALSE, fig.cap="Happy Little Accident", fig.align="center", out.width="90%"}
knitr::include_graphics("images/plotaccident-.png")
```
...
two variables
color, not fill
geom is "point", no need to specify it.
Try "jitter", which adds noise

```{console plot_scatter_ansi, trailing_spaces=TRUE, remove=c(-2, -1)}
rush plot --x bill --y tip --color sex tips.csv
```

```{console plot_scatter_png}
rush plot --x bill --y tip --color sex tips.csv > plot-scatter.png
display plot-scatter.png
```
```{r plot_scatter_image, echo=FALSE, fig.cap="Scatter Plot", fig.align="center", out.width="90%"}
...
rush plot --x bill --y tip --color sex --geom smooth tips.csv
```

```{console plot_trend_png}
rush plot --x bill --y tip --color sex --geom smooth tips.csv > plot-trend.png
...
```
```{r plot_boxplot_image, echo=FALSE, fig.cap="Box plot", fig.align="center", out.width="90%"}
...
```
```{r plot_labels_image, echo=FALSE, fig.cap="Violin plot with a title and labels", fig.align="center", out.width="90%"}
