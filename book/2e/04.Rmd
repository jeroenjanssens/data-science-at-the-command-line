...
Throughout the book, I'll introduce you to a lot of commands and pipelines that basically fit on one line.
Let's call those one-liners.
...
<!-- Maybe add reference to https://github.com/modernish/modernish -->
<!-- Maybe add reference to Chell check -->
