...
Let's test both tools on numbers 1 through 20:
...
You can test this yourself by piping the input data through `sample -d 100` before it's piped to the Python or R tool.
