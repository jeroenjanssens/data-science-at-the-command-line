...
Sometimes you will come across scripts that have a shebang in the form of *`!/usr/bin/bash`* or *`!/usr/bin/pytho`n* (in the case of Python, as we will see in the next section).
